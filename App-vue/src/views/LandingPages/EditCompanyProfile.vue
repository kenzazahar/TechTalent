  ...
  onMounted(async () => {
    try {
      ...
      const companyData = {
        ...
        description: "TechCorp est une entreprise innovante spécialisée dans le Dev Web...",
        website: "www.techcorp.ma",
        phoneNumber: "+212 576548221",
      ...
      Object.assign(formData, companyData);
    } catch (error) {
