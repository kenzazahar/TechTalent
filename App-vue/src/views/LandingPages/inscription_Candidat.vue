  ...
  <div class="login-page">
    <div class="login-container">
      ...
      <div class="header-center">
        ...
        <h2>Formulaire d'Insription Candidat</h2>
      ...
      <form @submit.prevent="handleFormSubmit">
        ...
        <div class="form-sections">
          <div class="form-section-left">
            ...
            <div class="form-group-inline">
              <div class="form-group">
                <label>Prénom</label>
                <input type="text" v-model="formData.firstName" placeholder="Entrez votre prénom" />
                <span v-if="errors.firstName" class="error">{{ errors.firstName }}</span>
              </div>
              <div class="form-group">
                <label>Nom</label>
                <input type="text" v-model="formData.lastName" placeholder="Entrez votre nom" />
            ...
            <div class="form-group">
              ...
              <input type="text" v-model="formData.phoneNumber" placeholder="Entrez votre numéro de téléphone" />
              <span v-if="errors.phoneNumber" class="error">{{ errors.phoneNumber }}</span>
            </div>

            <div class="form-group">
              <label>Nom d'utilisateur</label>
              <input type="text" v-model="formData.username" placeholder="Entrez votre nom d'utilisateur" />
          ...
          <div class="form-section-right">
            ...
            <div class="form-group">
              <h3>Informations sur l'Éducation</h3>
            </div>

            <div class="form-group">
              <label>Établissement</label>
              <input type="text" v-model="formData.institution" placeholder="Entrez votre établissement" />
              <span v-if="errors.institution" class="error">{{ errors.institution }}</span>
            </div>

            <div class="form-group">
              <label>Filière</label>
              <input type="text" v-model="formData.fieldOfStudy" placeholder="Entrez votre filière" />
              <span v-if="errors.fieldOfStudy" class="error">{{ errors.fieldOfStudy }}</span>
            </div>

            <div class="form-group">
              <label>Niveau d'étude</label>
              <input type="text" v-model="formData.educationLevel" placeholder="Entrez votre niveau d'étude" />
              <span v-if="errors.educationLevel" class="error">{{ errors.educationLevel }}</span>
            </div>

            <div class="form-group">
              <label>Année de graduation</label>
              <input type="text" v-model="formData.graduationYear" placeholder="Entrez votre année de graduation" />
              <span v-if="errors.graduationYear" class="error">{{ errors.graduationYear }}</span>
            </div>

            <div class="form-group">
              <label>Type de recherche</label>
              <input type="text" v-model="formData.researchType" placeholder="Entrez votre type de recherche" />
              <span v-if="errors.researchType" class="error">{{ errors.researchType }}</span>
            </div>

            <div class="form-group">
              <label>Date de disponibilité</label>
              <input type="text" v-model="formData.availabilityDate" placeholder="Entrez votre date de disponibilité" />
        ...
        <div class="form-section-center">
            ...
            <div class="form-group">
              <label>Email</label>
              <input type="email" v-model="formData.email" placeholder="Entrez votre email" />
              <span v-if="errors.email" class="error">{{ errors.email }}</span>
            </div>

            <div class="form-group">
              <label>Mot de passe</label>
              <input type="password" v-model="formData.password" placeholder="Entrez votre mot de passe" />
...
<style scoped>
  ...
  .form-section-center{
    ...
    justify-content: center;
    width: 65%; /* Ajustez si nécessaire */
