        ...
        <div class="form-sections">
          <div class="form-section-left">
            ...
            <div class="form-group">
              ...
              <input type="file" id="profile-photo" class="custom-file-input" @change="(e) => handleFileUpload(e, 'photo')" accept="image/*" />
              <label for="profile-photo">Choisir une photo</label>
            </div>

            <div class="form-group">
              <label>CV</label>
              <input type="file" id="cv-file" class="custom-file-input" @change="(e) => handleFileUpload(e, 'cv')" accept=".pdf,.doc,.docx" />
              <label for="cv-file">Choisir un CV</label>
            </div>

            <div class="form-group">
              <label>Portfolio</label>
              <input type="file" id="portfolio-file" class="custom-file-input" @change="(e) => handleFileUpload(e, 'portfolio')" accept=".pdf,.doc,.docx" />
...
onMounted(async () => {
  try {
    ...
    const candidateData = {
        firstName: "Kenza",
    lastName: "Zahar",
    username: "kenza.zahar",
    email: "kenza.zahar@email.com",
    phoneNumber: "+212 654789321",
    photo: "/src/assets/img/photo_kenza.jpg",
    institution: "ENSA",
    fieldOfStudy: "Génie Informatique",
    educationLevel: "Bac+4",
    graduationYear: "2026",
    researchType: "Stage PFA",
    availabilityDate: "Juillet 2025",
    };
    
    Object.assign(formData, candidateData);
  } catch (error) {
...
const saveChanges = async () => {
  try {
    // Simuler la sauvegarde vers l'API
